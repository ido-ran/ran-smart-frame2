...
export const GOOGLE_OAUTH_ENDPOINT_LOAD_START = 'GOOGLE_OAUTH_ENDPOINT_LOAD_START'
export const GOOGLE_OAUTH_ENDPOINT_LOAD_SUCCESS = 'GOOGLE_OAUTH_ENDPOINT_LOAD_SUCCESS'
export const GOOGLE_OAUTH_ENDPOINT_LOAD_FAIL = 'GOOGLE_OAUTH_ENDPOINT_LOAD_FAIL'
...
export function loadGoogleOAuthEndpoint() {
  return generateAction('/api/google-auth/endpoint', 
  GOOGLE_OAUTH_ENDPOINT_LOAD_START,
  GOOGLE_OAUTH_ENDPOINT_LOAD_SUCCESS,
  GOOGLE_OAUTH_ENDPOINT_LOAD_FAIL);
}